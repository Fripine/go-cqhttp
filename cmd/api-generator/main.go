...
func (g *generator) genRouter(routers []Router) {
	...
	g.WriteString("\"github.com/Fripine/go-cqhttp/coolq\"\n")
	g.WriteString("\"github.com/Fripine/go-cqhttp/global\"\n")
	g.WriteString("\"github.com/Fripine/go-cqhttp/pkg/onebot\"\n")
	g.WriteString(")\n\n")
