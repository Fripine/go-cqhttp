...
# 基础教程
## 下载
从[release](https://github.com/Fripine/go-cqhttp/releases)界面下载最新版本的go-cqhttp
...
```
2. 参照[config.md](https://github.com/Fripine/go-cqhttp/blob/master/docs/config.md)和你所用到的插件的 `README` 填入参数
...
4. 参照[config.md](https://github.com/Fripine/go-cqhttp/blob/master/docs/config.md)和你所用到的插件的 `README` 填入参数
...
1. [下载源码](https://github.com/Fripine/go-cqhttp/archive/master.zip)并解压 || 使用`git clone https://github.com/Fripine/go-cqhttp.git`来拉取
